...
//     >
//       <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl shadow-2xl border">
...
//             <label className="label font-medium">Images</label>
//             <input
//               {...register("images")}
...
//               type="submit"
//               disabled={isLoading}
//               className={`btn btn-primary w-full text-lg transition-all duration-200 ${
//                 isLoading ? "loading" : ""
//               }`}
//             >
