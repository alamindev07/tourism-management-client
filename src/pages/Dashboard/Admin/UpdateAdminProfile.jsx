          ...
          <div className="bg-white w-full max-w-md p-6 rounded-xl shadow-xl relative">
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="input input-bordered w-full dark:bg-slate-300 dark:text-black"
                  value={editData.name}
              ...
              <div>
                <label className="label text-gray-600">Image URL</label>
                <input
                  type="text"
                  className="input input-bordered w-full dark:bg-slate-300 dark:text-black"
              ...
              <div className="flex justify-end gap-3 pt-4">
                <button
                  ...
                  className="btn btn-ghost btn-outline text-red-500"
                >
                  Cancel
                </button>
